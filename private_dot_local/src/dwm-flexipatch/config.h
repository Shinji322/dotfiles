...
#else
static char *fonts[]          = { "monospace:size=10", "FontAwesome:size=10:antialias=true:autohint=true", "UbuntuMono Nerd Font:size=10:antialias=true:autohint=true"  };
...
static const Key keys[] = {
  ...
  { 0, XF86XK_AudioMute,		spawn,		SHCMD("wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle; kill -44 $(pidof dwmblocks)") },
	...
	#if RIODRAW_PATCH
	{ MODKEY|ControlMask,           XK_p,          riospawnsync,           {.v = menucmd } },
	{ MODKEY|ControlMask,           XK_Return,     riospawn,               SHCMD("sd") },
